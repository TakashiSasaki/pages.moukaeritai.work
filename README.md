...
Version: `1.7.29` (Release Candidate Documentation Polish & Go/No-Go Gate)
...
*   **Current Milestone**: Milestone 1.7.29 (Release Candidate Documentation Polish & Go/No-Go Gate)
...
- **Commit Format**: All changes must culminate in a descriptive English commit message outlining the milestone and patch alignment (e.g., `chore(release): close development-complete baseline at 1.7.29`).
