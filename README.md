...
*   **Current Milestone**: Milestone 1.6.0 (Organization-Specific Scan Mode Baseline)
...
- **Commit Format**: All changes must culminate in a descriptive English commit message outlining the milestone and patch alignment (e.g., `chore(release): generalize release gate for 1.6.0`).
