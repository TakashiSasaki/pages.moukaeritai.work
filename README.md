...
*   **Current Milestone**: Milestone 1.6.17 (Organization Scan Contract & Baseline Hardening)
...
- **Commit Format**: All changes must culminate in a descriptive English commit message outlining the milestone and patch alignment (e.g., `chore(release): close development-complete baseline at 1.6.17`).
