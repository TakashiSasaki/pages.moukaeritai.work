...
Version: `1.6.14` (Organization Scan Contract & Baseline Hardening)
...
In **Milestone 1.6.14**, the data structures have been fully upgraded to be **TTL-Ready**. All guest-created documents carry clean, standardized lifecycle fields.
