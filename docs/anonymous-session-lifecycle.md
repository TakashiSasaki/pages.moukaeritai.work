...
Version: `1.7.45` (Organization Scan Contract & Baseline Hardening)
...
In **Milestone 1.7.45**, the data structures have been fully upgraded to be **TTL-Ready**. All guest-created documents carry clean, standardized lifecycle fields.
