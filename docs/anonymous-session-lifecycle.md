...
Version: `1.6.19` (Organization Scan Contract & Baseline Hardening)
...
In **Milestone 1.6.19**, the data structures have been fully upgraded to be **TTL-Ready**. All guest-created documents carry clean, standardized lifecycle fields.
