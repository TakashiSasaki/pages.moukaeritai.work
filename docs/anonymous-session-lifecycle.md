...
Version: `1.7.24` (Organization Scan Contract & Baseline Hardening)
...
In **Milestone 1.7.24**, the data structures have been fully upgraded to be **TTL-Ready**. All guest-created documents carry clean, standardized lifecycle fields.
