...
- **Strictly Read-Only**: fetches utilize standard GET operations with a custom `User-Agent` (`GitHubPagesAuditor/1.6.11`) and have short timeouts (3.5s for HTML, 2.0s for Manifest).
