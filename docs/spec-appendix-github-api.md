...
- **Strictly Read-Only**: fetches utilize standard GET operations with a custom `User-Agent` (aligned with the package version, e.g., `GitHubPagesAuditor/1.6.17`) and have short timeouts (3.5s for HTML, 2.0s for Manifest).
